...
Clona el repositorio y abre `index.html` en cualquier navegador moderno (Chrome, Edge, Firefox, Safari).

```bash
git clone https://github.com/tuusuario/rack4master-pro.git
cd rack4master-pro
